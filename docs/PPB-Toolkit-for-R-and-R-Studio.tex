...
\hypersetup{
  pdftitle={A PPB Toolkit in R and RStudio},
...
\includegraphics{PPB-Toolkit-for-R-and-R-Studio_files/figure-latex/unnamed-chunk-53-1.pdf}
...
\includegraphics{PPB-Toolkit-for-R-and-R-Studio_files/figure-latex/unnamed-chunk-78-1.pdf}
...
\includegraphics[height=1.15\textheight]{PPB-Toolkit-for-R-and-R-Studio_files/figure-latex/unnamed-chunk-92-1}
...
\NormalTok{  adjusted.means}\SpecialCharTok{$}\NormalTok{location }\OtherTok{\textless{}{-}}\NormalTok{ myenv                         }\CommentTok{\# To our "adjusted.means" data frame, we add a column with the name of environment                        }
  \FunctionTok{assign}\NormalTok{(}\AttributeTok{value  =}\NormalTok{ adjusted.means[,}\FunctionTok{c}\NormalTok{(}\DecValTok{6}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{)],        }\CommentTok{\# I want to save the adjusted means object (rearrangin column order)}
